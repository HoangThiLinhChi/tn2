...
namespace PMQLKSCK.Controllers
{
    ...
    public class KhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Ma_Kh,Ho_Kh,Ten_Kh,SoCMT,SĐT")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Ma_Kh,Ho_Kh,Ten_Kh,SoCMT,SĐT")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult UploadFile(HttpPostedFileBase file)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                kh.Ma_Kh = dt.Rows[i][0].ToString();
                kh.Ho_Kh = dt.Rows[i][1].ToString();
                kh.Ten_Kh = dt.Rows[i][2].ToString();
                kh.SĐT = dt.Rows[i][3].ToString();
                kh.SoCMT = dt.Rows[i][4].ToString();
        ...
        public DataTable ReadDataFromExcelFile(string filepath)
        {
            ...
            if (fileExtention.IndexOf("xlsx") == 0)
            {
                ...
                //connectionString = "Provider = Microsoft.ACE.OLEDB.12.0; Data Source =" + filepath + ";Extended Properties=Excel 12.0;";
                //connectionString = "Provider=Microsoft.ACE.OLEDB.12.0;" + @"Data Source=C:\Users\ADMIN\Documents\Usecase_Final_Viwaco.xlsx;" + "Extended Properties=\"Excel 12.0;HDR=YES;\";" + "";
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["LTExcelDbContext"].ConnectionString);
            SqlBulkCopy bulkcopy = new SqlBulkCopy(con);
            bulkcopy.DestinationTableName = "KhachHangs";
            bulkcopy.ColumnMappings.Add(0,"Ma_Kh");
            bulkcopy.ColumnMappings.Add(1, "Ho_Kh");
            bulkcopy.ColumnMappings.Add(0, "Ten_Kh");
            bulkcopy.ColumnMappings.Add(1, "SoCMT");
            bulkcopy.ColumnMappings.Add(1, "SĐT");
